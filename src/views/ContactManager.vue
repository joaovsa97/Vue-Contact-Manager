<template>
    <div class="container mt-3">
        <div class="row">
            ...
            <p class="fst-italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, magni. Dolores sunt aut nobis ipsam reiciendis optio corrupti beatae? Quasi dicta cumque ullam magnam saepe sunt ducimus, repudiandae excepturi praesentium.</p>
                ...
                <div class="card my-2 list-group-item-success shadow-lg">
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-1 d-flex flex-column justify-content-cente align-items-center">
                                ...
                                <button class="btn btn-danger my-1" @click="deleteContact(contact.id)"><i class="fa fa-trash"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
